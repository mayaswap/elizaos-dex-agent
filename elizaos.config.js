...
import { WalletService } from './dist/services/walletService.js';
import { DatabaseService } from './dist/services/databaseService.js';
import { actions } from './dist/actions/index.js';
...
// Extended runtime interface for our services (removed TypeScript interface)

/**
 * Global ElizaOS Agent Configuration
 * This creates a runtime that works with ALL ElizaOS clients
 */
export async function createGlobalElizaOSRuntime() {
    try {
